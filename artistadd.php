...
if (isset($_POST['submit'])) {
  $mysqli = NEW MySQLi('localhost','root','','banana');

  $aname = $_POST['aname'];
  $description = $_POST['description'];

  $query = $mysqli->query("SELECT * FROM artists WHERE aname = '$aname'");

  if(empty($aname) or empty($description)){
  ...
  elseif($query->num_rows != 0) {
    ...
    $insert = $mysqli->query("INSERT INTO artists(aname,description) VALUES('$aname','$description')");
  ...
  <div class="col-lg-6">
                      <div class="card">
                        <div class="card-header">
                          <strong>Register an artist</strong>
                        </div>
                        <div class="card-body card-block">
                          <form action="artistadd.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                            <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Artist's Name</label></div>
                            <div class="col-12 col-md-9"><input type="text" id="text-input" name="aname" placeholder="Artist's Name" class="form-control"><small class="form-text text-muted">Enter artist's name</small></div>
                          </div>
                          <div class="row form-group">
                          <div class="col col-md-3"><label for="text-input" class=" form-control-label">Description</label></div>
                          <div class="col-12 col-md-9"><input type="text" id="text-input" name="description" placeholder="Description" class="form-control"><small class="form-text text-muted">Enter artist's description</small></div>
                        </div>
                        <div class="row form-group">
